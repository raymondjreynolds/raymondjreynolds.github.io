...
var documents = [{
    "id": 0,
    "url": "http://localhost:4000/raymondjreynolds.github.io/404.html",
    "title": "404",
    "body": "404 Page does not exist. . . yet!Please use the search bar at the top or visit our homepage! "
    }, {
    "id": 1,
    "url": "http://localhost:4000/raymondjreynolds.github.io/about",
    "title": "Raymond J. Reynolds",
    "body": "Education: Stanford University 2014-2018 BS Electrical Engineering w/ minor in Management Science and Engineering Skills: - Python - C++ / C# / Arduino C - R / MATLAB LinkedInWork Experience: Software Engineer - Microsoft: Nov 2019 - Current As a member of Azure's SQL Database team, I am working towards further optimizing internal resource management. Specifically, I am leading a rework of hard disk related management strategy by leveraging time series data. Software Engineer - Cisco Systems: June 2018 - Nov 2019 My main responsibilities at Cisco involved developing internal automation tools and applications. Some of the specific processes I leveraged were data analysis, real-time telemetry streaming, and machine learning. Additionally, I led a small subteam initiative to research &amp; prototype machine learning models with the intent to optimize, streamline, and automate current development + testing workflows. We applied clustering algorithms, Naive Bayes Classifiers, neural networks, and decision trees on medium-sized datasets (~20000 observations). Technical Evaluations Intern - Lenovo: June 2017 - Sep 2017 As a summer intern, I independently built a price prediction tool to enhance the statistical validity of competitive pricing reports. The model used a k-Nearest Neighbor algorithm driven by a modified text difference algorithm. k-Fold Cross Validation on 9000+ observations showed that the model's predicted price fell within user-defined tolerance roughly 80% of each test set. The results of the competitive pricing models influence Lenovo's Marketing, Design, and other business decisions. Undergraduate Research Assistant - Stanford University: June 2016 - Jan 2017 This research project called the Quantum Tunneling Electron Platform (QTEP) was an experimental device aimed at identifying carcinogenic or other atypical proteins present in a blood sample. I helped build the classification pipeline by applying wavelet decomposition techniques which served as the dominant features in a Random Forrest Classifier. Independent Projects: Stanford Solar Car Project: Sep 2015 - June 2018 I worked on the Electrical System team where I designed and built the steering wheel circuitry (LCD screen, vehicle buttons, radio button). The steering wheel served as the main way the driver interacted with the car, save for the accelerator/brake pedals. The schematics and PCB layout were done using Altium, and the initial board bringup + debug was done in-house. Additionally, I jumpstarted prospective research into implementing autonomous or semi-autonomous systems that may enhance future iterations of solar cars. Co-founder Helmetrics: Jan 2018 - Present Helmetrics was initially an Entrepreneurship class project started with the idea of producing a mass-market appropriate concussion monitoring system. I built the initial prototype using a single MEMs gyroscope and Arduino. Additionally, I honed prospective business and revenue models through analyzing feedback from early marketing intiatives. I am currently enhancing the real-time motion tracking software, as well as researching multi-sensor architectures for a much more comprehensive model of head movements.  Autonomous RC Car: June 2017 - Present The Autonomous RC Car is a hobby that I tinker with to understand the fundamentals of autonomous vehicle systems. I used a LIDAR sensor and Arduino microcontroller to implement simple versions of 'Pre-collision braking' and 'Adaptive Cruise Control' systems. The communication between the sensor and Arduino follows I2C protocol. I also replaced the standard battery pack with a rechargeable pack and solar panel. The next enhancements could be to integrate a camera and implement simple computer vision functionality. "
    }, {
    "id": 2,
    "url": "http://localhost:4000/raymondjreynolds.github.io/categories",
    "title": "Categories",
    "body": ""
    }, {
    "id": 3,
    "url": "http://localhost:4000/raymondjreynolds.github.io/",
    "title": "Home",
    "body": "      Welcome to my Online Portfolio!:         Hello! I'm Raymond. This is my personal portfolio. It is a work-in-progress.    "
    }, {
    "id": 4,
    "url": "http://localhost:4000/raymondjreynolds.github.io/recipes",
    "title": "Raymond's Recipes",
    "body": "Stay Tuned for my first few recipes!: In the meantime, please continue browsing the site. Also consider subscribing for the latest homecooked recipes!   {% include pagination. html %}"
    }, {
    "id": 5,
    "url": "http://localhost:4000/raymondjreynolds.github.io/robots.txt",
    "title": "",
    "body": "      Sitemap: {{ “sitemap. xml”   absolute_url }}   "
    }, {
    "id": 6,
    "url": "http://localhost:4000/raymondjreynolds.github.io/page2/",
    "title": "Home",
    "body": "{% if page. url == “/” %}       Welcome to my Online Portfolio!:         Hello! I'm Raymond. This is my personal portfolio. It is a work-in-progress.    {% endif %} "
    }, {
    "id": 7,
    "url": "http://localhost:4000/raymondjreynolds.github.io/powerful-things-markdown-editor/",
    ...
    "id": 8,
    "url": "http://localhost:4000/raymondjreynolds.github.io/first-mass-produced/",
    ...
    "id": 9,
    "url": "http://localhost:4000/raymondjreynolds.github.io/education/",
    ...
    "id": 10,
    "url": "http://localhost:4000/raymondjreynolds.github.io/acumulated-experience/",
    ...
    "id": 11,
    "url": "http://localhost:4000/raymondjreynolds.github.io/about-bundler/",
    "title": "About Bundler",
    ...
    "id": 12,
    "url": "http://localhost:4000/raymondjreynolds.github.io/we-all-wait-for-summer/",
    ...
    "id": 13,
    "url": "http://localhost:4000/raymondjreynolds.github.io/tree-of-codes/",
    "title": "Tree of Codes",
    ...
    "id": 14,
    "url": "http://localhost:4000/raymondjreynolds.github.io/red-riding/",
    "title": "Red Riding Hood",
    "body": "2018/01/12 - The first mass-produced book to deviate from a rectilinear format, at least in the United States, is thought to be this 1863 edition of Red Riding Hood, cut into the shape of the protagonist herself with the troublesome wolf curled at her feet. Produced by the Boston-based publisher Louis Prang, this is the first in their “Doll Series”, a set of five “die-cut” books, known also as shape books — the other titles being Robinson Crusoe, Goody Two-Shoes (also written by Red Riding Hood author Lydia Very), Cinderella, and King Winter. An 1868 Prang catalogue would later claim that such “books in the shape of a regular paper Doll… originated with us”.  It would seem the claim could also extend to die cut books in general, as we can’t find anything sooner, but do let us know in the comments if you have further light to shed on this! Such books are, of course, still popular in children’s publishing today, though the die cutting is not now limited to mere outlines, as evidenced in a beautiful 2014 version of the same Little Red Riding Hood story. The die cut has also been employed in the non-juvenile sphere as well, a recent example being Jonathan Safran Foer’s ambitious Tree of Codes. As for this particular rendition of Charles Perrault’s classic tale, the text and design is by Lydia Very (1823-1901), sister of Transcendentalist poet Jones Very. The gruesome ending of the original — which sees Little Red Riding Hood being gobbled up as well as her grandmother — is avoided here, the gore giving way to the less bloody aims of the morality tale, and the lesson that one should not disobey one’s mother. "
    }, {
    "id": 15,
    "url": "http://localhost:4000/raymondjreynolds.github.io/press-and-education/",
    ...
    "id": 16,
    "url": "http://localhost:4000/raymondjreynolds.github.io/options-for-creating-new-site-with-jekyll/",
    ...
    "id": 17,
    "url": "http://localhost:4000/raymondjreynolds.github.io/never-stopped-worrying-never-loved-bomb/",
    ...
    "id": 18,
    "url": "http://localhost:4000/raymondjreynolds.github.io/is-intelligence-enough/",
    ...
    "id": 19,
    "url": "http://localhost:4000/raymondjreynolds.github.io/quick-start-guide/",
    ...
    "id": 20,
    "url": "http://localhost:4000/raymondjreynolds.github.io/customer-service/",
